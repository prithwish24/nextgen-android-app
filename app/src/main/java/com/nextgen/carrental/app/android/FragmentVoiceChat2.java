...
public class FragmentVoiceChat2 extends Fragment implements AIButton.AIButtonListener {
    private static final String TAG = FragmentVoiceChat2.class.getName();
    private View view;
    ...
    private void onPermissionGranted() {
        ...
        if (permissionManager.hasPermission(getContext(), Manifest.permission.RECORD_AUDIO)) {
            ...
            aiButton.setPartialResultsListener(new FragmentVoiceChat2.MyResultListener());
        }
